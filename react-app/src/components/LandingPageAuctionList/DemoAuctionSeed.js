...
// #for owner 2
    ...
    description : "The Alberti and Trithemius are a pair of keys recovered from the depths of the Baltic, rumored to have the ability to dismantle any lock, no matter the build or complexity. (FBM Marketplace absolves itself from any crimes or wrongdoing committed with s obtained through its auctions)",
    ...
    description : "Another auction  with the mysterious ability to defy gravity. May have been used as monetary compensation for plumbing work.",
